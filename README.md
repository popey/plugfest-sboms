...
| binary | jq | syft | 1.18.0 | [cyclonedx-json_enriched.json](./binary/syft/1.18.0/jq/plug-jq/cyclonedx-json_enriched.json) | [sbom-utility](./binary/syft/1.18.0/jq/plug-jq/cyclonedx-json_enriched.json_sbom_utility.txt) | Pass |
